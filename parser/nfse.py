...
def parser_nfse(xml_data):
    ...
    for inf_nfse in nfse_list:
        ...
        data["Valor Pis"] = get_text(servico, './/Valores/ValorPis', ns)
        data["Valor Cofins"] = get_text(servico, './/Valores/ValorCofins', ns)
        data["Valor Inss"] = get_text(servico, './/Valores/ValorInss', ns)
        data["Valor Ir"] = get_text(servico, './/Valores/ValorIr', ns)
        data["Valor Csll"] = get_text(servico, './/Valores/ValorCsll', ns)
        data["ISS Retido"] = get_text(servico, './/Valores/IssRetido', ns)
        data["Valor ISS"] = get_text(servico, './/Valores/ValorIss', ns)
        data["Valor ISS Retido"] = get_text(servico, './/Valores/ValorIssRetido', ns)
        ...
        # Tomador de Serviço
        data["CNPJ Tomador"] = get_text(tomador, './/IdentificacaoTomador/CpfCnpj/Cnpj', ns)
